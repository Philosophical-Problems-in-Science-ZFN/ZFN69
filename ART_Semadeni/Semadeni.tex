...
%	were precursors of the theory) and its initial development. The question of 
...
\myquote{it is very hard to put oneself back in 
...
\myquote{
The theory [\ldots] emphasizes that, whenever new abstract objects are 
...
a common practice, even when these correspondences were dealt with in a single 
