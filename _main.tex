...
\newcommand{\pasekpl}{%
	...
	\begin{footnotesize}CC-BY-NC-ND 4.0\end{footnotesize}\end{subsubsectit}%
		\enspace\raisebox{-1.75pt}{\includegraphics[height=9.5pt]{images/CC-BY-NC-ND}}}%
}
\newcommand{\pasekeng}{%
	\placetextbox{153mm}{-3mm}{\begin{subsubsectit}\begin{small}%
...
\input{ART_Heller_Awodey/Heller_Awodey.tex}

\input{ART_Marquis/Marquis.tex}

\input{ART_Semadeni/Semadeni.tex}

\input{ART_McLarty/McLarty.tex}

\renewcommand{\theequation}{\arabic{section}.\arabic{equation}}
\input{ART_Majid/Majid.tex} %do poprawy
\renewcommand{\theequation}{\arabic{equation}}

\input{ART_Kycia_Niemczynowicz/Kycia_Niemczynowicz.tex}

\input{ART_Woszczek/Woszczek-PU.tex}

\input{ART_Kus/Kus.tex}

\input{ART_Stopa/Stopa.tex}
...
\input{REC_Stopa/Stopa.tex}
%
\input{REC_Krzanowski/Krzanowski-PU.tex}
